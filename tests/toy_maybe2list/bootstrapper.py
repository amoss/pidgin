...
def build():
    '''
    A (recursive) definition of a list that may contain up to two items.
    '''
    g = Grammar("atom")
    ...
    aord = g.addRule("order", [g.Terminal('['), g.Nonterminal("atom", "optional"), g.Nonterminal("atom", "optional"), g.Terminal(']')])
